  ...
  return (
    <div className="space-y-5">
      <Card>
        ...
        <p className="mt-2 text-sm text-ink-muted">Marcar uma aula registra estudo. O domínio exige acertos conferidos em pelo menos {MASTERY.questoesCorretas} questões distintas, um novo acerto pelo menos um dia depois, ao menos {MASTERY.precisaoMinima}% nas últimas {MASTERY.janelaRecente} tentativas e nenhum erro pendente. Autoavaliações ajudam você, mas não certificam domínio.</p>
