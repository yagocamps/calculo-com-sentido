...
export const continuidadeAulas: Record<string, AulaContent> = {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "cont-g3",
          type: "compreensao",
          enunciado: "A temperatura de uma sala ao longo do dia é contínua; o número de pessoas na sala não é. Qual a diferença?",
          resposta: "A temperatura passa por todos os valores intermediários; a contagem de pessoas salta de inteiro em inteiro",
          resolucao: "Para ir de 20°C a 22°C, a temperatura passa por 20,5°C, 21°C e assim por diante. Já a quantidade de pessoas vai de 3 para 4 sem nunca valer 3,5.",
          interpretacao: "Continuidade não é sobre a fórmula ser bonita: é sobre a grandeza mudar sem dar saltos. Muitos modelos do Cálculo só valem para grandezas contínuas.",
          erroComum: "Confundir contínua com \"sempre crescente\" — uma função pode subir, descer e continuar contínua.",
        },
      ],
    },
  ...
  "furos-saltos": {
    ...
    explicacao: {
      ...
      formula: "Buraco: lim f(x) = L ≠ f(a) | Salto: lim(x→a⁻) ≠ lim(x→a⁺)",
      formulaLatex: "\\text{Buraco: } \\lim f(x) = L \\neq f(a) \\quad \\text{Salto: } \\lim_{x\\to a^-} f(x) \\neq \\lim_{x\\to a^+} f(x)",
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          id: "fs-g2",
          type: "interpretacao",
          enunciado: "\\(\\lim_{x\\to 2^-} f(x)=0\\) e \\(\\lim_{x\\to 2^+} f(x)=5\\). Tipo?",
          resposta: "Salto.",
          ...
          id: "fs-g3",
          type: "interpretacao",
          enunciado: "\\(f(x) = \\frac{1}{x - 4}\\). Que tipo de descontinuidade existe em \\(x = 4\\)?",
          resposta: "Descontinuidade infinita (assíntota vertical)",
          resolucao: "Perto de \\(4\\) o denominador tende a zero e \\(|f|\\) cresce sem limite: \\(\\lim_{x \\to 4^-} f = -\\infty\\) e \\(\\lim_{x \\to 4^+} f = +\\infty\\).",
          interpretacao: "Diferente do buraco, aqui não há valor que se possa colar em \\(x = 4\\) para consertar: a função dispara nos dois lados.",
          erroComum: "Chamar de removível — removível é quando o limite existe e é finito, faltando só o ponto.",
        },
      ],
    },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "as-g3",
          type: "calculo",
          enunciado: "\\(f(x) = \\frac{2x}{x - 3}\\). (a) Onde \\(f\\) é descontínua? (b) Qual a assíntota horizontal?",
          resposta: "(a) Somente em \\(x = 3\\); (b) \\(y = 2\\)",
          resolucao: "(a) O denominador zera apenas em \\(x = 3\\); em todo o resto a função é contínua. (b) Graus iguais no numerador e no denominador: razão dos coeficientes, \\(y = 2\\).",
          interpretacao: "Função racional é contínua em todo o seu domínio. A descontinuidade não fica espalhada: mora exatamente onde o denominador zera.",
          erroComum: "Dizer que a função é descontínua \"perto\" de 3 — ela é contínua em todo ponto diferente de 3, por mais próximo que esteja.",
        },
      ],
    },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "cp-g3",
          type: "calculo",
          enunciado: "\\(f(x) = x^2\\) para \\(x \\leq 1\\) e \\(f(x) = ax + 3\\) para \\(x > 1\\). Qual valor de \\(a\\) torna \\(f\\) contínua em \\(x = 1\\)?",
          resposta: "\\(a = -2\\)",
          resolucao: "Pela esquerda, \\(x^2 \\to 1\\), e \\(f(1) = 1\\). Pela direita, \\(ax + 3 \\to a + 3\\). Para colar as duas partes: \\(a + 3 = 1 \\Rightarrow a = -2\\).",
          interpretacao: "Continuidade num ponto exige três coisas: a função existe ali, o limite existe, e os dois coincidem. Aqui só a terceira dependia de \\(a\\).",
          erroComum: "Igualar as duas expressões sem substituir \\(x = 1\\), tentando resolver \\(x^2 = ax + 3\\).",
        },
      ],
    },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "ci-g3",
          type: "interpretacao",
          enunciado: "\\(f\\) é contínua em \\([0,\\ 3]\\), com \\(f(0) = -4\\) e \\(f(3) = 5\\). Dá para garantir que \\(f\\) tem uma raiz nesse intervalo?",
          resposta: "Sim: existe pelo menos um \\(c\\) em \\((0,\\ 3)\\) com \\(f(c) = 0\\)",
          resolucao: "A função é contínua e muda de sinal (de \\(-4\\) para \\(5\\)). Para ir de negativo a positivo sem saltar, ela precisa cruzar o zero.",
          interpretacao: "É o Teorema do Valor Intermediário: continuidade garante que nenhum valor entre \\(-4\\) e \\(5\\) foi pulado. Ele não diz onde está a raiz, só que existe.",
          erroComum: "Achar que o teorema informa quantas raízes existem ou onde elas estão — ele garante ao menos uma.",
        },
      ],
    },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "rc-g3",
          type: "compreensao",
          enunciado: "\\(f(x) = |x|\\). (a) É contínua em \\(x = 0\\)? (b) É derivável em \\(x = 0\\)?",
          resposta: "(a) Sim; (b) não",
          resolucao: "(a) \\(\\lim_{x \\to 0} |x| = 0 = f(0)\\), então é contínua. (b) A inclinação vale \\(-1\\) à esquerda e \\(1\\) à direita: não existe uma única tangente.",
          interpretacao: "Contínua não implica derivável. A implicação só vale num sentido: derivável \\(\\Rightarrow\\) contínua. O bico do \\(|x|\\) é o contraexemplo padrão.",
          erroComum: "Inverter a implicação e concluir que toda função contínua é derivável.",
        },
      ],
    },
