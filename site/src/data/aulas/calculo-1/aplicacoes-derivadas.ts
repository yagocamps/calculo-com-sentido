  ...
  "lucro-maximo": {
    ...
    explicacao: {
      ...
      paragraphs: [
        ...
        "Igualar as marginais dá um candidato, não a resposta: confirme com \\(L''\\), com o sinal de \\(L'\\) em volta do ponto ou comparando o lucro nas bordas do domínio.",
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          resolucao: "\\(R'(x) = 60 - x\\) e \\(C'(x) = 10\\). Igualando: \\(60 - x = 10 \\Rightarrow x = 50\\) — esse é o ponto crítico. Como \\(L(x) = 50x - 0{,}5x^2 - 200\\) tem \\(L''(x) = -1 < 0\\), o crítico é mesmo máximo. Daí \\(L(50) = 1750 - 700 = 1050\\).",
          interpretacao: "Produza enquanto a receita marginal supera o custo marginal; pare quando se igualam. Mas repare na ordem: \\(R' = C'\\) apenas localizou o candidato, e foi \\(L'' < 0\\) que garantiu que ali é máximo e não mínimo.",
    ...
    resumo: {
      ...
      bullets: [
        ...
        "Confirme o máximo com \\(L''<0\\) ou com as bordas do domínio.",
