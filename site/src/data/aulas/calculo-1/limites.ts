    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "tab-g3",
          type: "interpretacao",
          enunciado: "Tabela de \\(f(x) = \\frac{|x - 4|}{x - 4}\\): \\(3{,}9 \\to -1\\) · \\(3{,}99 \\to -1\\) · \\(4{,}01 \\to 1\\) · \\(4{,}1 \\to 1\\). O que ela mostra?",
          resposta: "Laterais diferentes: \\(\\lim_{x \\to 4} f(x)\\) não existe.",
          resolucao: "À esquerda de \\(4\\) a razão vale \\(-1\\); à direita, \\(1\\). Não há um único \\(L\\).",
          interpretacao: "É a tabela bilateral que revela isso — testar só um lado daria uma conclusão errada.",
          erroComum: "Tirar a média dos dois lados e responder \\(0\\).",
        },
      ],
    },
    exerciciosAplicados: {
  ...
  "limite-por-grafico": {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "graf-g3",
          type: "interpretacao",
          enunciado: "A curva tende a \\(y = 3\\) pelos dois lados quando \\(x \\to 2\\), mas há um ponto isolado marcado em \\((2, 5)\\). Quanto valem \\(\\lim_{x \\to 2} f(x)\\) e \\(f(2)\\)?",
          resposta: "Limite \\(3\\); \\(f(2) = 5\\)",
          resolucao: "A tendência dos dois lados é \\(3\\). O ponto isolado define \\(f(2) = 5\\) e não altera a tendência.",
          interpretacao: "Limite e valor podem existir e ser diferentes — é a descontinuidade removível.",
          erroComum: "Achar que o ponto isolado \"puxa\" o limite para \\(5\\).",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    resumo: {
      ...
      bullets: [
        ...
        "Próximo: as propriedades que permitem quebrar um limite em partes.",
      ],
    },
  },
  ...
  "limite-substituicao": {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "sub-g3",
          type: "calculo",
          enunciado: "\\(\\lim_{x \\to 2} \\frac{x^2 - 5x + 6}{x - 2}\\)",
          resposta: "\\(-1\\)",
          resolucao: "Substituir dá \\(\\frac{0}{0}\\). Fatorando: \\(\\frac{(x-2)(x-3)}{x-2} = x - 3 \\to 2 - 3 = -1\\).",
          interpretacao: "\\(\\frac{0}{0}\\) não é resposta: é aviso de que existe fator comum para cancelar.",
    ...
    resumo: {
      ...
      bullets: [
        ...
        "Próximo: o que fazer quando a substituição dá \\(0/0\\).",
      ],
    },
  },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "lat-g3",
          type: "calculo",
          enunciado: "\\(f(x) = x + 1\\) para \\(x < 3\\) e \\(f(x) = 2x - 2\\) para \\(x \\geq 3\\). Calcule os dois limites laterais em \\(3\\) e diga se \\(\\lim_{x \\to 3} f(x)\\) existe.",
          resposta: "Ambos valem \\(4\\); o limite existe e vale \\(4\\)",
          resolucao: "Esquerda: \\(x + 1 \\to 3 + 1 = 4\\). Direita: \\(2x - 2 \\to 6 - 2 = 4\\). Iguais.",
          interpretacao: "Função por partes pode ser costurada sem salto — basta os dois lados chegarem no mesmo valor.",
          erroComum: "Trocar qual expressão vale antes e depois de \\(3\\).",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "inf-g3",
          type: "calculo",
          enunciado: "\\(\\lim_{x \\to 2} \\frac{1}{(x - 2)^2}\\). Os dois lados dão o mesmo resultado?",
          resposta: "\\(+\\infty\\) pelos dois lados",
          resolucao: "\\((x-2)^2 > 0\\) sempre; perto de \\(2\\) o denominador vira \\(0^+\\), e \\(\\frac{1}{0^+} \\to +\\infty\\).",
          interpretacao: "O quadrado apaga o sinal — diferente de \\(\\frac{1}{x-2}\\), que troca de sinal em cada lado.",
          erroComum: "Copiar o comportamento de \\(\\frac{1}{x}\\) e responder \\(+\\infty\\) e \\(-\\infty\\).",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "ninf-g3",
          type: "calculo",
          enunciado: "\\(\\lim_{x \\to +\\infty} \\frac{x^2 + 1}{x + 4}\\)",
          resposta: "\\(+\\infty\\)",
          resolucao: "Dividindo por \\(x\\): \\(\\frac{x + \\frac{1}{x}}{1 + \\frac{4}{x}}\\); o numerador cresce sem limite e o denominador tende a \\(1\\).",
          interpretacao: "Grau de cima maior que o de baixo: a função dispara e não há assíntota horizontal.",
          erroComum: "Usar a razão dos coeficientes, que só vale quando os graus são iguais.",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "ass-g3",
          type: "calculo",
          enunciado: "\\(f(x) = \\frac{3x}{x - 2}\\). Quais são as assíntotas vertical e horizontal?",
          resposta: "\\(x = 2\\) e \\(y = 3\\)",
          resolucao: "Denominador zera em \\(x = 2\\) (vertical). Graus iguais \\(\\to\\) razão dos coeficientes: \\(y = 3\\).",
          interpretacao: "Vertical vem do denominador; horizontal vem do comportamento no infinito. São perguntas diferentes.",
          erroComum: "Procurar assíntota oblíqua aqui — ela só aparece quando o grau de cima é exatamente um a mais.",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "vel-g3",
          type: "calculo",
          enunciado: "\\(s(t) = t^2\\) (metros). Calcule a velocidade média em \\([2,\\ 2 + \\Delta t]\\) e depois o limite quando \\(\\Delta t \\to 0\\).",
          resposta: "Média \\(4 + \\Delta t\\); instantânea \\(4\\) m/s",
          resolucao: "\\(\\frac{(2 + \\Delta t)^2 - 2^2}{\\Delta t} = \\frac{4\\Delta t + (\\Delta t)^2}{\\Delta t} = 4 + \\Delta t \\to 4\\).",
          interpretacao: "Aqui média e instantânea diferem, ao contrário do movimento uniforme — é o limite que separa as duas.",
          erroComum: "Substituir \\(\\Delta t = 0\\) antes de simplificar e travar em \\(\\frac{0}{0}\\).",
        },
      ],
    },
    exerciciosAplicados: {
  ...
  "aplicacoes-limites": {
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "apl-g3",
          type: "aplicada",
          enunciado: "O custo médio por unidade é \\(\\bar{C}(q) = \\frac{5000}{q} + 12\\) reais. Para onde \\(\\bar{C}\\) tende quando \\(q \\to +\\infty\\)?",
          resposta: "Tende a R$ 12,00 por unidade",
          resolucao: "\\(\\frac{5000}{q} \\to 0\\) quando \\(q\\) cresce; sobra o \\(12\\).",
          interpretacao: "O custo fixo se dilui na escala, mas o custo médio nunca desce abaixo dos R$ 12 do custo variável — esse é o piso.",
          erroComum: "Achar que o custo médio tende a zero porque o custo fixo se dilui.",
        },
      ],
    },
    exerciciosAplicados: {
    ...
    resumo: {
      ...
      bullets: [
        ...
        "Próximo: o Teorema do Confronto e os limites fundamentais.",
      ],
    },
  },
    ...
    exerciciosGuiados: {
      ...
      exercises: [
        ...
        },
        {
          ...
          id: "revl-g3",
          type: "calculo",
          enunciado: "\\(\\lim_{x \\to 1} \\frac{x^2 - 1}{x^2 - 3x + 2}\\)",
          resposta: "\\(-2\\)",
          resolucao: "\\(\\frac{0}{0}\\) na substituição. Fatorando os dois: \\(\\frac{(x-1)(x+1)}{(x-1)(x-2)} = \\frac{x+1}{x-2} \\to \\frac{2}{-1} = -2\\).",
          interpretacao: "Fatorar numerador e denominador é o caminho padrão sempre que \\(\\frac{0}{0}\\) aparece.",
          erroComum: "Cancelar o \\(x^2\\) de cima com o de baixo — só se cancela fator, nunca parcela.",
        },
      ],
    },
    exerciciosAplicados: {
