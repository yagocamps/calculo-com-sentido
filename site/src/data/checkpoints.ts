...
export const moduleCheckpoints: Record<string, ModuleCheckpointData> = {
  ...
  "pre-calculo/geometria-analitica": {
    ...
    questions: [
      ...
      { prompt: "A reta que passa por \\((1, 3)\\) e \\((4, 9)\\) é...", options: ["\\(y = 2x + 1\\)", "\\(y = 3x\\)", "\\(y = \\frac{1}{2}x + 3\\)", "\\(y = 2x + 3\\)"], correctIndex: 0, explanation: "\\(m = \\frac{9 - 3}{4 - 1} = 2\\); com \\((1, 3)\\): \\(y - 3 = 2(x - 1)\\), isto é, \\(y = 2x + 1\\).", reviewHref: "/pre-calculo/geometria-analitica/equacao-da-reta" },
