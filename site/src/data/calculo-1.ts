...
export const calculo1Modulos: TrilhaModuloData[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "derivada-composta", title: "Regra da cadeia: composição e várias camadas", duration: "20 min", available: true },
  ...
  },
  {
    ...
    lessons: [
      ...
      ...calculo1Phase2Catalog.integrais.filter((lesson) => lesson.slug === "somas-de-riemann"),
